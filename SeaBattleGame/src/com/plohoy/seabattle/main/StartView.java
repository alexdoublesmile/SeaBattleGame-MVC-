...
public class StartView extends JFrame {
	...
	private final String CONFIRM_VIEW = "В какой тип Морского Боя желаете сыграть?";
	private final String CONFIRM_AI_POWER = "С насколько мощным соперником Вы желаете сразиться?";
	private final String CONFIRM_HUMAN_OPPONENT = "С кем желаете сыграть партию?";
	...
	public int displayOpponentHumanConfirmMessage(String message) {
		String[] answers = {"С компьютером", "С человеком (в разработке)", };
		return JOptionPane.showOptionDialog(
